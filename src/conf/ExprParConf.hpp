...
double ExprPar::min_interaction = 0.1;
double ExprPar::max_interaction = 1000.0001;
double ExprPar::min_effect_Logistic = -5;
double ExprPar::max_effect_Logistic = 5;
double ExprPar::min_effect_Thermo = 0.99;
double ExprPar::max_effect_Thermo = 100.0001;
double ExprPar::min_repression = 9.9E-6;
double ExprPar::max_repression = 1.0;
...
double ExprPar::default_beta = 1.0;
